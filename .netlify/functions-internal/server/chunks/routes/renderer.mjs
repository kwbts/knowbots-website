...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Archivo:wght@400;700&family=EB+Garamond:wght@400;700&family=Alegreya:wght@400;700&display=swap"}],"style":[],"script":[],"noscript":[]};
